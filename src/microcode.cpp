...
void insertSTAX(DecodeROM* rom, uint32_t rp)
{
	...
	ib.nextCycle(MachineCycleType::MemoryWrite, 3, true)
		.nextState()
			...
			.flags_none()
			.internalRegisters_disabled()
			.registerFile(RegisterFileSrcReg::B, RegisterFileDstReg::B, RegisterFileSrcRegPair::fromInstruction(rp), RegisterFileDstRegPair::fromInstruction(rp), RegisterFileRegPairOp::Zero, false, false, false)
			.misc_StatusWordOut()
			.flow_continue()
		.end()
		.nextState()
...
void insertRegisterPairOp(DecodeROM* rom, uint32_t rp, RegisterFileRegPairOp::Enum op)
{
	...
	ib.nextCycle(MachineCycleType::InstructionFetch, 5, true)
		.nextState()
			...
			.flags_none()
			.internalRegisters_disabled()
			.registerFile(RegisterFileSrcReg::B, RegisterFileDstReg::B, RegisterFileSrcRegPair::fromInstruction(rp), RegisterFileDstRegPair::fromInstruction(rp), op, false, false, false) // Prepare result
			.misc_DataIn()
			.flow_continue()
		.end()
		.nextState()
			...
			.flags_none()
			.internalRegisters_disabled()
			.registerFile(RegisterFileSrcReg::B, RegisterFileDstReg::B, RegisterFileSrcRegPair::fromInstruction(rp), RegisterFileDstRegPair::fromInstruction(rp), op, false, false, true) // Write result
			.misc_DataIn()
			.flow_continue()
		.end()
		.nextState()
...
{
	InstructionBuilder ib(3, romAllocStates(rom, 6), 6);
	...
	ib.nextCycle(MachineCycleType::InstructionFetch, 1, false)
		...
		.end()
	.end()
	.nextCycle(MachineCycleType::HaltAck, 2, true)
		.nextState()
			.state_T1()
			.alu_disabled()
			.flags_none()
...
{
	// TODO: Not implemented in the circuit
	insertNOP(rom);
}
...
void insertResetSequence(DecodeROM* rom)
{
	...
	ib.nextCycle(MachineCycleType::Internal, 3, true)
		...
		.nextState() // PCL = 0
			...
			.flags_none()
			.internalRegisters_disabled()
			.registerFile(RegisterFileSrcReg::PCL, RegisterFileDstReg::PCL, RegisterFileSrcRegPair::PC, RegisterFileDstRegPair::PC, RegisterFileRegPairOp::Zero, false, true, false)
			.misc(InternalDataBusSrc::ALU, 0, false, 0, false, false)
			.flow_continue()
		.end()
		.nextState() // PCH = 0
			...
			.flags_none()
			.internalRegisters_disabled()
			.registerFile(RegisterFileSrcReg::PCH, RegisterFileDstReg::PCH, RegisterFileSrcRegPair::PC, RegisterFileDstRegPair::PC, RegisterFileRegPairOp::Zero, false, true, false)
			.misc(InternalDataBusSrc::ALU, 0, false, 0, false, false)
			.flow_continue()
		.end()
	.end()
